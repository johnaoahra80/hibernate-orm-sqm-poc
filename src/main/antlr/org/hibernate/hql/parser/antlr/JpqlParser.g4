...
updateStatement
// todo : add set-clause
	: updateKeyword mainEntityPersisterReference setKeyword updateItem (COMMA updateItem)* whereClause?
	;
...
// Update statment
updateItem
	: expression EQUAL new_value
	;

//	: (identification_variable DOT)?{state_field |
//          single_valued_association_field} EQUALS new_value
